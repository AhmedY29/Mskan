...
import { login, logout, register , verifyEmail, forgotPassword,resetPassword, checkAuth, getUser, editUser, getEditUser, changePass, getUsers} from '../controllers/auth.controller.js';
